  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        problem:
          'Building a DevOps platform architecture for a multi-stack ecosystem (Go, Java, Node.js, frontend) from scratch means satisfying several constraints at the same time: security must be enforced at every stage rather than bolted on later, every environment must stay identical and reproducible from a single source, every release needs a complete audit trail, and the whole system has to run without any manual step that could be skipped or forgotten. Meeting all of those together, not just one or two, is where the actual architectural work is.',
