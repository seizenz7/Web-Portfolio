  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        result:
          'Sebelumnya, merilis versi baru satu layanan saja bisa menyita hampir seharian, melibatkan beberapa orang, dan tetap berakhir dengan sesuatu yang tidak sinkron. Setelah seluruh setup CI/CD dan GitOps berjalan, rilis berubah dari proses manual yang tidak teratur menjadi deployment yang otomatis, konsisten, dan bisa diaudit. Usaha manual berkurang 60%, siklus rilis lebih cepat 35%, dan stack observabilitas yang memberikan visibilitas penuh dan membantu identifikasi akar masalah menjadi lebih mudah, cepat dan efisien, sehingga memangkas rata-rata waktu penyelesaian insiden hampir 50% lebih cepat.',
      },
    ],
  },
